...
// Welcome show summary of current Ethereum instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic Ethereum metadata
	fmt.Fprintf(c.printer, "Welcome to the Ethereum JavaScript console!\n\n")
	c.jsre.Run(`
