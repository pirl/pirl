...
import (
	...
	"git.pirl.io/community/pirl/graphql"
...
func loadConfig(file string, cfg *pirlConfig) error {
	f, err := os.Open(file)
	if err != nil {
		return err
	}
...
func makeConfigNode(ctx *cli.Context) (*node.Node, pirlConfig) {
	// Load defaults.
	cfg := pirlConfig{
