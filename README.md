...
For prerequisites and detailed build instructions please read the [Installation Instructions](https://git.pirl.io/community/pirl/wiki/Building-Ethereum) on the wiki.
...
[CLI Wiki page](https://git.pirl.io/community/pirl/wiki/Command-Line-Options)),
...
and [`geth` specific APIs](https://git.pirl.io/community/pirl/wiki/Management-APIs)).
