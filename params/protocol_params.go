...
var (
	...
	Fork51Block                   = int64(2300000)     // block we will fork for the 51
	HulkEnforcementBlockThreshold = uint64(10)         // Threshold of blocks that can be delayed and the value is in Blocks
)
