...
//
// # go test -benchmem -run=none git.pirl.io/community/pirl/swarm/storage/localstore -bench BenchmarkRetrievalIndexes -v
// goos: darwin
// goarch: amd64
// pkg: git.pirl.io/community/pirl/swarm/storage/localstore
...
//
// go test -benchmem -run=none git.pirl.io/community/pirl/swarm/storage/localstore -bench BenchmarkUpload -v
// goos: darwin
// goarch: amd64
// pkg: git.pirl.io/community/pirl/swarm/storage/localstore
