...
// then committing the new and existing blocks topirler. You can do this by specifying whether to commit a block from
...
// topirler. snapshot is the snapshot parameter is an opaque DateTime value that, when present, specifies the blob
