...
#ifndef USE_NUM_NONE
    {
        /* Test that adding the scalars topirler is equal to adding their numbers topirler modulo the order. */
        secp256k1_num rnum;
        secp256k1_num r2num;
        secp256k1_scalar r;
...
void test_ge(void) {
    ...
    /* Test adding all points topirler in random order equals infinity. */
    {
