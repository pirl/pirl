...
import (
	...
	"github.com/DaCHRIS/Iceberg-/internal/build"
)
...
func doAndroidArchive(cmdline []string) {
	...
	build.MustRun(gomobileTool("bind", "--target", "android", "--javapkg", "org.ethereum", "-v", "github.com/DaCHRIS/Iceberg-/mobile"))
...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/DaCHRIS/Iceberg-/mobile")
