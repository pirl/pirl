...
# 1. install pirl for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for pirl
# 5. create pirl, attach and uninstall start menu entries
...
function .onInit
  # make vars are global for all users since pirl is installed global
