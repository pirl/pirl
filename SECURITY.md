...
Audit reports are published in the `docs` folder: https://git.pirl.io/community/pirl/tree/master/docs/audits 


| Scope | Date | Report Link |
| ------- | ------- | ----------- |
| `geth` | 20170425 | [pdf](https://git.pirl.io/community/pirl/blob/master/docs/audits/2017-04-25_Geth-audit_Truesec.pdf) |
| `clef` | 20180914 | [pdf](https://git.pirl.io/community/pirl/blob/master/docs/audits/2018-09-14_Clef-audit_NCC.pdf) |
