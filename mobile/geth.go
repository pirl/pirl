...
// NodeConfig represents the collection of configuration values to fine tune the Ethereum
...
// Node represents a Ethereum Ethereum node instance.
type Node struct {
	node *node.Node
}

// NewNode creates and configures a new Ethereum node.
