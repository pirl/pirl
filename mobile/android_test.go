...
public class AndroidTest extends InstrumentationTestCase {
	...
	public void testAccountManagement() {
		...
		KeyStore ks = new KeyStore(getInstrumentation().getContext().getFilesDir() + "/keystore", pirl.LightScryptN, pirl.LightScryptP);
...
func TestAndroid(t *testing.T) {
	...
	// Generate the mobile bindings for pirl and add the tester class
